# Generated by Django 5.0.1 on 2024-01-27 18:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'verbose_name_plural': 'actions tags',
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(max_length=20, validators=[common.utils.validate_phone_number], verbose_name='phone number')),
                ('work_time', models.CharField(max_length=20, verbose_name='work time')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('video', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='common.media')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'verbose_name_plural': 'actions images',
            },
        ),
        migrations.AddField(
            model_name='action',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('certificates', ckeditor.fields.RichTextField(verbose_name='certificates')),
                ...
                ('experience_in_year', models.CharField(max_length=10, verbose_name='experience in year')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('order', models.IntegerField(verbose_name='order')),
                ('story', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='videos', to='clinics.story')),
