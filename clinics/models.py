...
class Vacancy(models.Model):
    ...
    # TODO: Think - add is_active field
...
class Action(models.Model):
    ...
    tags = models.ManyToManyField("ActionTag", verbose_name=_("action tag"), blank=True)
    ...
    def clean(self):
        if self.expires_in < datetime.date.today():
            raise ValidationError(_("Expires in date must be greater than today !"))
...
class ActionTag(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = _("actions tags")
...
class ActionImage(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = _("actions images")
...
class PhotoGallery(models.Model):
    ...
    category = models.ForeignKey(PhotoGalleryCategory, on_delete=models.CASCADE, verbose_name=_("category"))
...
class Specialist(models.Model):
    ...
    experience_in_year = models.CharField(_("experience in year"), max_length=10)
...
class Diploma(models.Model):
    specialist = models.ForeignKey(Specialist, on_delete=models.CASCADE, related_name="diplomas")
...
class Contacts(models.Model):
    ...
    phone_number = models.CharField(_("phone number"), max_length=20,
                                    validators=[validate_phone_number])
    work_time = models.CharField(_("work time"), max_length=20)
    telegram = models.URLField(_("telegram"),
                               validators=[RegexValidator(r'^https?:\/\/t\.me\/[A-Za-z0-9_]{5,}$')])
